...
export enum I18nKey {
  ...
  AUTH$CHECKING_AUTHENTICATION = "AUTH$CHECKING_AUTHENTICATION",
  AUTH$FAILED_GITHUB_LOGIN = "AUTH$FAILED_GITHUB_LOGIN",
  AUTH$SIGN_IN_TO_START = "AUTH$SIGN_IN_TO_START",
  AUTH$SIGN_IN_WITH_EMAIL = "AUTH$SIGN_IN_WITH_EMAIL",
  AUTH$CONTINUE_WITH_GITHUB = "AUTH$CONTINUE_WITH_GITHUB",
  AUTH$TERMS_PRIVACY_NOTICE = "AUTH$TERMS_PRIVACY_NOTICE",
  AUTH$OTP_SENT = "AUTH$OTP_SENT",
  AUTH$FAILED_SEND_OTP = "AUTH$FAILED_SEND_OTP",
  AUTH$ENTER_OTP_CODE = "AUTH$ENTER_OTP_CODE",
  AUTH$LOGIN_SUCCESSFUL = "AUTH$LOGIN_SUCCESSFUL",
  AUTH$INVALID_EXPIRED_OTP = "AUTH$INVALID_EXPIRED_OTP",
  AUTH$ENTER_EMAIL_FOR_CODE = "AUTH$ENTER_EMAIL_FOR_CODE",
  AUTH$ENTER_CODE_SENT_TO_EMAIL = "AUTH$ENTER_CODE_SENT_TO_EMAIL",
  AUTH$CODE_SENT_TO = "AUTH$CODE_SENT_TO",
  AUTH$VERIFICATION_CODE = "AUTH$VERIFICATION_CODE",
  AUTH$USE_DIFFERENT_EMAIL = "AUTH$USE_DIFFERENT_EMAIL",
  AUTH$SEND_CODE = "AUTH$SEND_CODE",
  AUTH$VERIFY_SIGN_IN = "AUTH$VERIFY_SIGN_IN",
  AUTH$VIEW_GITHUB_PROFILE = "AUTH$VIEW_GITHUB_PROFILE",
  AUTH$SIGN_OUT = "AUTH$SIGN_OUT",
  AUTH$ENTER_EMAIL_ADDRESS = "AUTH$ENTER_EMAIL_ADDRESS",
  AUTH$EMAIL_ADDRESS = "AUTH$EMAIL_ADDRESS",
  AUTH$ENTER_YOUR_EMAIL = "AUTH$ENTER_YOUR_EMAIL",
  AUTH$ENTER_6_DIGIT_CODE = "AUTH$ENTER_6_DIGIT_CODE",
